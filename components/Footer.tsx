...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-black text-white overflow-hidden pt-24 pb-0 w-full">
      {/* Background Graphic */}
      <div className="absolute top-[-10%] left-[-15%] w-[100%] h-[120%] opacity-[0.08] pointer-events-none select-none z-0">
        <svg viewBox="0 0 100 100" className="w-full h-full fill-white" preserveAspectRatio="xMinYMin meet">
          <path d="M10,10 H45 C75,10 95,30 95,60 C95,90 75,110 45,110 H10 V10 Z M25,25 V95 H45 C65,95 80,80 80,60 C80,40 65,25 45,25 H25 Z" />
          <path d="M10,50 H40 C50,50 58,58 58,68 C58,78 50,86 40,86 H10 V50 Z" />
        </svg>
      </div>

      {/* Main Content Area */}
      <div className="max-w-[1440px] mx-auto px-10 lg:px-24 relative z-10 pb-20">
