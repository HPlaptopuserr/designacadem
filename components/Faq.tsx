...
const faqs = [
  {
    ...
    answer: "Бид олон улсын жишгийн дагуу боловсруулсан хөтөлбөрөөр, бодит төсөл дээр суурилсан дадлага олгодог.",
  },
  {
  ...
  },
  {
    ...
    answer: "Тийм ээ, бид танхимын сургалтаас гадна цаг зав муутай хүмүүст зориулсан хөтөлбөртэй.",
  },
  {
    question: "Танайх сертвикат олгох уу?",
    answer: "Тийм. Сургалтаа амжилттай төгссөн бүх сурагчдад албан ёсны сертификат олгоно.",
  },
];
