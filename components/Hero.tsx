...
const HERO_VIDEOS = [
  { id: 'c8nx06K_08M', title: 'UX Design Process', img: '/hero/video.png' },
  { id: 'zXidXHe7xIs', title: 'UI Design Principles', img: '/hero/video1.png' },
  { id: '96mS7Xh_X2g', title: 'Figma Mastery', img: '/hero/video2.jpg' },
];
      ...
      <div className="max-w-[1440px] mx-auto">
        <div className="mb-20">
          <div className="flex flex-col lg:flex-row lg:items-end gap-x-6 leading-[0.85]">
            <span className="text-[#ccff00] text-[120px] lg:text-[180px] tracking-tighter">
              {HERO_CONTENT.highlight}
            </span>
            <div className="flex flex-col pb-4 lg:pb-8">
              <span className="text-black text-[48px] lg:text-[64px] uppercase tracking-tight">
          ...
          <h1 className="text-black text-[80px] lg:text-[90px] uppercase leading-none tracking-tight">
...
function Thumbnail({ imgSrc, onClick }: ThumbnailProps) {
  return (
    <div 
      onClick={onClick}
